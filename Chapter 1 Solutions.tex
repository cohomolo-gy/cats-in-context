...
Now lets show $(\Leftarrow)$. Let $f_*$ be a surjection for all $c \in \cc$. Note that in $\opc$, $\op{f_*} : \opc(y,c) \to \opc(x,c)$ is an injection. By 1.2.7, this is equivalent to epimorphism $f: x \to y$ in $\cc$.
